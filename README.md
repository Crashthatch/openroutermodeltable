...
- **Total Prompt Tokens**: Total number of prompt tokens processed for this model
- **Total Completion Tokens**: Total number of completion tokens generated by this model
